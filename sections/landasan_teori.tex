...
\begin{subs}
    ...
    \addimagetolist{Fluktuasi Harga Saham}{chart_saham.png}
	\end{figure}
...
\begin{subs}
    ...
    \addimagetolist{Pendekatan Kecerdasan Buatan}{artificial intelligence.jpg}
	\end{figure}
...
\begin{subs}
	...
	\begin{figure}[H]
		...
		\caption{Python}
    \addimagetolist{Python}{python.jpg}
	\end{figure}
...
\begin{subs}
    ...
    \addimagetolist{Algoritma LSTM \textit{(source: \cite{SaulDobilas})}}{lstm.png}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[b]{0.45\textwidth}
			...
			% \caption{Forget Gate}
      \addimagetolist{Forget Gate}{step1.png}
		\end{subfigure}
		\hfill
	...
	\begin{figure}[H]
      ...
      \addimagetolist{Input Gate}{step2.png}
			% \caption{Input Gate}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.5\textwidth}
	...
	\begin{figure}[H]
      ...
      \addimagetolist{Pembaruan Cell State}{step3.png}
	...
	\begin{figure}[H]
      ...
      \addimagetolist{Output Gate}{step4.png}
			% \caption{Output Gate}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.5\textwidth}
