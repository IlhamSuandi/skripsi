...
% Define a new List of Images
\newcommand{\listofimagesname}{Daftar Gambar}
\newlistof{imagelist}{img}{\listofimagesname}

% Command to add an image entry to the custom list
\newcommand{\addimagetolist}[2]{%
  \addcontentsline{img}{imagelist}{\protect Gambar \numberline{\thefigure}\hspace{2pt}#1}% Add the image to the custom ToC
}

% Create a new list for longtables
\newcommand{\listoflongtablesname}{Daftar Tabel}
\newlistof{longtablelist}{lt}{\listoflongtablesname}

% Command to add longtable entries to the custom list
\newcommand{\addlongtabletolist}[1]{%
  \addcontentsline{lt}{longtablelist}{\protect Tabel \numberline{\thetable}#1}%
}

% Print the list of longtables
\newcommand{\listoflongtables}{%
  \begingroup
    \let\thepage\relax
    \listof{longtablelist}{\listoflongtablesname}%
  \endgroup
}
...
% List of Images
\listoflongtables % This prints the list of longtables
...
\input{sections/batasan_masalah.tex}
...
\input{sections/landasan_teori.tex}
\input{sections/studi_literatur.tex}
...
\input{sections/lokasi_penelitian.tex}
\input{sections/waktu_penelitian.tex}
\input{sections/subjek_penelitian.tex}
\input{sections/fokus_penelitian.tex}
\input{sections/sumber_data.tex}
\input{sections/pengumpulan_data.tex}
\input{sections/tahapan_penelitian.tex}
